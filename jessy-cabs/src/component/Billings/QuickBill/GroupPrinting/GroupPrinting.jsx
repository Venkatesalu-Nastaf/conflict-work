...
const GroupPrinting = () => {
    ...
    return (
        <div className="GroupPrinting-form Scroll-Style-hide">
            <form >
                <div className="detail-container-main">
                    <div className="container-left">
                        <div className="copy-title-btn-GroupPrinting">
                ...
                <div className="table-bookingCopy-GroupPrinting">
