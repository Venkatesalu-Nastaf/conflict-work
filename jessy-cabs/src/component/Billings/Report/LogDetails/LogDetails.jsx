...
const LogDetails = () => {
  ...
  //         const differenceKeys = Object.entries(differences).map(([subKey, value]) => (
  //           <div
  //             key={subKey}
  //             style={{
  //               border: value ? "2px solid red" : "none",
  //               padding: "4px",
  //               display: "inline-block",
  //               marginRight: "8px",
  //             }}
  //           >
  //             {subKey}: {value ? "True" : "False"}
  //           </div>
  //         ));
...
//       if (key) {
//       // renderCell = (params) => {if()
//       renderCell = (params) => {
//   const { row } = params; // Extract the row object
//   const differences = row.differences; // Extract the `difference` object

//   return (
//     <div>
//       {Object.entries(differences).map(([key, value1]) => {
//         // Check if the key exists in `differences` and if its value is `true`
//         // const isHighlighted = key === params.field ? value;
//         const isHighlighted = key === params.field && value1 === true;

//         return (
//           <div
//             key={key}
//             style={{
//               color: isHighlighted ? "red" : "black", // Red color if highlighted
//               fontWeight: isHighlighted ? "bold" : "normal", // Optional: Bold for highlighted
//               marginBottom: "4px", // Add spacing for readability
//             }}
//           >
//           {params.value}
//           </div>
...
// }
  ...
  //   <div
  //     style={{
  //       border: "2px solid red", // Apply a red border around the entire object
  //       padding: "8px", // Add some padding for better appearance
  //       borderRadius: "4px", // Optional: For rounded corners
  //     }}
  //   >
  //   {params.value}
  //     {/* {Object.entries(params.row[key]).map(([subKey, value]) => (
  //       <div key={subKey}>
  //         {subKey}: {value ? "True" : "False"}
  //       </div>
  //     ))} */}
    ...
    if (event.key === "Enter") {
      ...
      try {
        ...
        if (bookingDetails.length > 0) {
          ...
          const dataWithKeyDifferences = bookingDetails
