...
// Add the new vehicles to the list
// const updatedNotAssignedVehicles = [...allNotAssignedVehicles, ...newVehicles];
// Join into a single comma-separated string
const allNotAssignedVehiclesString = updatedNotAssignedVehicles.join(',');


try {
  // const vehicleOnlineDetailsResponse = await axios.get(`${apiUrl}/particularVehicleDetails/${allNotAssignedVehiclesString}`);
