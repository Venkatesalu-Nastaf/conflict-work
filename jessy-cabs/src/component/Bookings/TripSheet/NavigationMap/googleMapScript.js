...
function submitPopup() {
    ...
    if (tripTypeElement) {
        ...
        console.error("Element with ID 'tripType' not found");
    }
}
...
function generateStaticMap() {
    ...
    // const staticMapUrl = `https://maps.googleapis.com/maps/api/staticmap?center=${mapCenter.lat},${mapCenter.lng}&zoom=${mapZoom}&size=1600x600&dpi=720`;
