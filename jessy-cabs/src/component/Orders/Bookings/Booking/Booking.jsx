            ...
            <div className="input-field">
              <div className="input">
                {/* <Autocomplete
                  ...
                  renderInput={(params) => (
                    <TextField {...params} name='report' label="Report" />
                  )}
                /> */}
                <Autocomplete
                  fullWidth
            ...
            <div className="input-field">
              ...
              <div className="input">
                ...
                {/* <Autocomplete
                  ...
                  getOptionLabel={(option) => option.label || ""}
                  renderInput={(params) => (
                    <TextField {...params} name='servicestation' label="Service Station" />
                  )}
                /> */}
                <Autocomplete
                  fullWidth
                          ...
                          <div className="input-field billing">
                            <div className="input">
                              ...
                              <TextField
                                name="addressupdate"
                                autoComplete="new-password"
                                value={selectedCustomerData.addressupdate || book.addressupdate}
                                onChange={handleChange}
                                label="Address"
                                id="address4"
                                variant="standard"
            ...
            <div className="input-field">
              <div className="input">
                ...
                {/* <Autocomplete
                  ...
                  getOptionLabel={(option) => option.label || ""}
                  renderInput={(params) => (
                    <TextField {...params} name='vehiclemodule' label="Vehicle Module" />
                  )}
                /> */}
                <Autocomplete
                  fullWidth
