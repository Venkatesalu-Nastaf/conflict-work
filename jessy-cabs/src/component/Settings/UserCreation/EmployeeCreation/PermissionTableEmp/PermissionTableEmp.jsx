...
import './PermissionTableEmp.css'

const label = { inputProps: { 'aria-label': 'Switch demo' } };


export const PermissionTableEmp = ({ userid, permissionsData, handleSwitchChange, handleCheckboxChange, setReadState, readState, newState, modifyState, deleteState, handleSwitchforthatrow, handleSwitchforallrows, handleCheckboxChangealldata }) => {
// console.log(newState,readState,modifyState,deleteState,"state")
          ...
          <tbody className='table-body'>
            ...
            <tr >
              <td className='td-content-og Booking-table-og user-permission-table-title' onClick={() => togglerow("BILLING")}>
                ...
                <Switch
                  checked={permissionsData[4]?.read && permissionsData[5]?.read && permissionsData[6]?.read && permissionsData[7]?.read && permissionsData[8]?.read && permissionsData[9]?.read} onChange={handleSwitchforallrows(4, 9)}
                  inputProps={{ 'aria-label': 'controlled' }}
                />
              </td>
              ...
              <td className='td-content'><input type="checkbox" checked={permissionsData[4]?.read} onChange={handleCheckboxChangealldata(4, 9, 'read')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[4]?.new} onChange={handleCheckboxChangealldata(4, 9, 'new')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[4]?.modify} onChange={handleCheckboxChangealldata(4, 9, 'modify')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[4]?.delete} onChange={handleCheckboxChangealldata(4, 9, 'delete')} /></td>
            </tr>
            ...
            {BILLING && <>
              ...
              <tr>
                ...
                <td className='td-content'><input type="checkbox" checked={permissionsData[8]?.delete} onChange={handleCheckboxChange(8, 'delete')} /></td>
                   ...
                   <tr>
                <td className='td-content-og'>vendor Reports <Switch
            ...
            <tr className='user-permission-even-no-rows'>
              ...
              <td className='td-content-og Booking-table-og user-permission-table-title' onClick={() => togglerow("REGISTER")}>Register {REGISTER ? (<span style={{marginTop:"10px"}}> <FaChevronUp /> </span>) : (<span style={{marginTop:"10px"}}><FaChevronDown /></span>)}
                <Switch
                  checked={permissionsData[10]?.read && permissionsData[11]?.read && permissionsData[12]?.read && permissionsData[13]?.read && permissionsData[14]?.read} onChange={handleSwitchforallrows(10, 14)}
                  inputProps={{ 'aria-label': 'controlled' }}
                /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[10]?.read} onChange={handleCheckboxChangealldata(10, 14, 'read')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[10]?.new} onChange={handleCheckboxChangealldata(10, 14, 'new')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[10]?.modify} onChange={handleCheckboxChangealldata(10, 14, 'modify')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[10]?.delete} onChange={handleCheckboxChangealldata(10, 14, 'delete')} /></td>
            </tr>
            ...
            <tr >
              ...
              <td className='td-content-og Booking-table-og user-permission-table-title' onClick={() => togglerow("SETTING")}>Setting {SETTING ? (<span style={{marginTop:"10px"}}> <FaChevronUp /> </span>) : (<span style={{marginTop:"10px"}}><FaChevronDown /></span>)}
                <Switch
                  checked={permissionsData[15]?.read && permissionsData[16]?.read && permissionsData[17]?.read} onChange={handleSwitchforallrows(15, 17)}
                  inputProps={{ 'aria-label': 'controlled' }}
                />
              </td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[15]?.read} onChange={handleCheckboxChangealldata(15, 17, 'read')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[15]?.new} onChange={handleCheckboxChangealldata(15, 17, 'new')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[15]?.modify} onChange={handleCheckboxChangealldata(15, 17, 'modify')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[15]?.delete} onChange={handleCheckboxChangealldata(15, 17, 'delete')} /></td>
            </tr>
            ...
            <tr className='user-permission-even-no-rows'>
              ...
              <td className='td-content-og Booking-table-og user-permission-table-title' onClick={() => togglerow("INFO")}>Info {INFO ? (<span style={{marginTop:"10px"}}> <FaChevronUp /> </span>) : (<span style={{marginTop:"10px"}}><FaChevronDown /></span>)}
                <Switch
                  checked={permissionsData[18]?.read && permissionsData[19]?.read && permissionsData[20]?.read && permissionsData[21]?.read && permissionsData[22]?.read} onChange={handleSwitchforallrows(18, 22)}
                  inputProps={{ 'aria-label': 'controlled' }}
                />
              </td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[18]?.read} onChange={handleCheckboxChangealldata(18, 22, 'read')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[18]?.new} onChange={handleCheckboxChangealldata(18, 22, 'new')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[18]?.modify} onChange={handleCheckboxChangealldata(18, 22, 'modify')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[18]?.delete} onChange={handleCheckboxChangealldata(18, 22, 'delete')} /></td>
            </tr>
            ...
            {/* <tr>
              ...
              <td className='td-content-og Booking-table-og user-permission-table-title' onClick={() => togglerow("MAP")}>Map {MAP ? (<span style={{marginTop:"10px"}}> <FaChevronUp /> </span>) : (<span style={{marginTop:"10px"}}><FaChevronDown /></span>)}
                <Switch
                  checked={permissionsData[24]?.read && permissionsData[25]?.read && permissionsData[26]?.read && permissionsData[27]?.read && permissionsData[28]?.read && permissionsData[29]?.read} onChange={handleSwitchforallrows(24, 29)}
                  inputProps={{ 'aria-label': 'controlled' }}
                />
              </td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[24]?.read} onChange={handleCheckboxChangealldata(24, 29, 'read')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[24]?.new} onChange={handleCheckboxChangealldata(24, 29, 'new')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[24]?.modify} onChange={handleCheckboxChangealldata(24, 29, 'modify')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[24]?.delete} onChange={handleCheckboxChangealldata(24, 29, 'delete')} /></td>
            </tr>
            {/* {MAP && <>
...
<tr>
  <td className='td-content-og'>Records<Switch
    checked={permissionsData[29]?.read && permissionsData[29]?.new && permissionsData[29]?.modify && permissionsData[29]?.delete} onChange={handleSwitchforthatrow(29)}
    inputProps={{ 'aria-label': 'controlled' }}
  /></td>
  <td className='td-content'><input type="checkbox" checked={permissionsData[29]?.read} onChange={handleCheckboxChange(29, 'read')} /></td>
  <td className='td-content'><input type="checkbox" checked={permissionsData[29]?.new} onChange={handleCheckboxChange(29, 'new')} /></td>
  <td className='td-content'><input type="checkbox" checked={permissionsData[29]?.modify} onChange={handleCheckboxChange(29, 'modify')} /></td>
  <td className='td-content'><input type="checkbox" checked={permissionsData[29]?.delete} onChange={handleCheckboxChange(29, 'delete')} /></td>
</tr>
  ...
  <tr >
              {/* <td className='td-content Booking-table-og'  ><span>REGISTER</span>{issettingDropdownVisible ? (<span> <CiCircleChevUp className='table-up-down-icon' />  </span>) : (<span><CiCircleChevDown className='table-up-down-icon' /></span>)}</td> */}
              <td className='td-content-og Booking-table-og user-permission-table-title' onClick={() => togglerow("PAYMENT")}>Payment {PAYMENT ? (<span style={{marginTop:"10px"}}> <FaChevronUp /> </span>) : (<span style={{marginTop:"10px"}}><FaChevronDown /></span>)}
                <Switch
                  checked={permissionsData[30]?.read && permissionsData[31]?.read && permissionsData[32]?.read} onChange={handleSwitchforallrows(30, 32)}
                  inputProps={{ 'aria-label': 'controlled' }}
                />
              </td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[30]?.read} onChange={handleCheckboxChangealldata(30, 32, 'read')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[30]?.new} onChange={handleCheckboxChangealldata(30, 32, 'new')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[30]?.modify} onChange={handleCheckboxChangealldata(30,32, 'modify')} /></td>
              <td className='td-content'><input type="checkbox" checked={permissionsData[30]?.delete} onChange={handleCheckboxChangealldata(30, 32, 'delete')} /></td>
            </tr>

            {PAYMENT && <>
              <tr>
                <td className='td-content-og'>Vendorpayment <Switch
                  checked={permissionsData[31]?.read && permissionsData[31]?.new && permissionsData[31]?.modify && permissionsData[31]?.delete} onChange={handleSwitchforthatrow(31)}
                  inputProps={{ 'aria-label': 'controlled' }}
                /></td>
                <td className='td-content'><input type="checkbox" checked={permissionsData[31]?.read} onChange={handleCheckboxChange(31, 'read')} /></td>
                <td className='td-content'><input type="checkbox" checked={permissionsData[31]?.new} onChange={handleCheckboxChange(31, 'new')} /></td>
                <td className='td-content'><input type="checkbox" checked={permissionsData[31]?.modify} onChange={handleCheckboxChange(31, 'modify')} /></td>
                <td className='td-content'><input type="checkbox" checked={permissionsData[31]?.delete} onChange={handleCheckboxChange(31, 'delete')} /></td>
              </tr>

              <tr>
                <td className='td-content-og'>Customerpayment<Switch
                  checked={permissionsData[32]?.read && permissionsData[32]?.new && permissionsData[32]?.modify && permissionsData[32]?.delete} onChange={handleSwitchforthatrow(32)}
                  inputProps={{ 'aria-label': 'controlled' }}
                /></td>
                <td className='td-content'><input type="checkbox" checked={permissionsData[32]?.read} onChange={handleCheckboxChange(32, 'read')} /></td>
                <td className='td-content'><input type="checkbox" checked={permissionsData[32]?.new} onChange={handleCheckboxChange(32, 'new')} /></td>
                <td className='td-content'><input type="checkbox" checked={permissionsData[32]?.modify} onChange={handleCheckboxChange(32, 'modify')} /></td>
                <td className='td-content'><input type="checkbox" checked={permissionsData[32]?.delete} onChange={handleCheckboxChange(32, 'delete')} /></td>
              </tr>
