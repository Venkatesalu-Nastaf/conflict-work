...
import useVendorInvoice from './useVendorInvoice.js';
import { usePayment } from '../paymentContext.js';
import PdfInvoice from './PdfInvoice.jsx';
import { useInvoice } from './invoiceContext.js';


const VendorInvoice = ( {target} ) => {
  const {
  ...
  const { openInvoice, setOpenInvoice } = useInvoice()

  const { addPayment, paymentData } = usePayment()
  ...
  return (
    <div className="main-content-form main-content-form-invoice Scroll-Style-hide">
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="lg" fullWidth>
        <DialogTitle>Vendor Trip Details</DialogTitle>
            ...
            >
              <DataGrid
                rows={(selectedCustomerData?.trips || []).map((trip, i) => ({
                  id: i + 1,
                  ...trip,
                  vendorname: selectedCustomerData.vendorname,
                }))}
                columns={[
